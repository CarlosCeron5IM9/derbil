...
<html>
    ...
    <body>
      ...
      <div class="container">
        ...
        <form action="Controller/LevantarRepo.jsp" method="post">
            <h2>Levantar Reporte</h2>
            Fecha del registro de evento: 
            <input type="date" name="FechaRE" placeholder="DD/MM/AA"/>
            <br><br>
            Descripción del reporte de evento:<br>
            <textarea name="DescRE" placeholder="Descripción" style="height: 250px"></textarea>
            <br><br>
