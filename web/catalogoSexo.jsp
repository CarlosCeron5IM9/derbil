                    ...
                    <div class="col-md-12" style="border-width: 1px 1px 1px 1px; border-style: solid; border-color: lightgrey; background: #f1f3f6;">
                        <div class="col-md-8 col-md-offset-2">
                            <div class="control-group form-group">
                                <div class="controls">
                                    <br>
                                    <form id="form" name="form" action="catalogoSexo2.jsp" method="post">
                                        <label>
                                        Sexo
                                        </label>
                                        <br><br>
                                        ...
                                        <br><br>
                                        <input class="btn btn-info" type="submit" name="catalogoSexo" id="catalogoSexo" value="Buscar">
