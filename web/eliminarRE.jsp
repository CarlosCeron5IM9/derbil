      ...
      <div class="container">
        ...
        <tbody>
            <%
                ...
                String query1="select * from ReporteEventos, Usuario where Usuario.IdUser=ReporteEventos.IUser and ReporteEventos.StatusRE='Solucionado';"; 
                String query2="select * from ReporteEventos, Usuario, Usu_has_RepEve where Usuario.IdUser=Usu_has_RepEve.IUser and ReporteEventos.IdRe=Usu_has_RepEve.IRE  and ReporteEventos.StatusRE='Solucionado';";         
            ...
            <tr>
                ...
                <th><%=Fe%></th>
                <th><%=Des%></th>
                <th><form action="Controller/EliminarRepo.jsp">
                        <button name="IdRE" value=<%=Id%>>Cerrar</button>
                    </form></th>
