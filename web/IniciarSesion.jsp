        ...
        <div class="col s4">
          ...
          <div class="row">
           <div class="input-field col s12">
             ...
             <input id="Usuario" type="text" class="validate" name="NomUsuario" oncopy="return false" onpaste="return false" pattern="[A-Za-z0-9]{1,8}" required>
          ...
          <div class="row">
           <div class="input-field col s12">
             ...
             <input id="Contraseña" type="password" class="validate" name="Pass" oncopy="return false" onpaste="return false" pattern="[A-Za-z0-9]{1,8}" required>
