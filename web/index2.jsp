    ...
    <nav>
      <div class="nav-wrapper grey darken-3">
          ...
          <ul id="nav-mobile" class="right hide-on-med-and-down">
              <%
                            Fotografos f = (Fotografos)session.getAttribute("user");
                            session.setAttribute("user",f);
                            if(f == null){
                                %>
            <li><a href="index.jsp"><i class="material-icons left">undo</i>Cliente</a></li>                    
            <li><a href="Sesion.jsp"><i class="material-icons left">face</i>Iniciar Sesion</a></li>
            <li><a href="registrarFotografo.jsp"><i class="material-icons left">person</i>Registro</a></li>
